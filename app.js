...
if (!MONGO_URL) {
    console.error('Environment variable ATLAS_DB is not set. Copy .env.example to .env and fill values.');
    process.exit(1);
}

const store = MongoStore.create({
    mongoUrl: MONGO_URL, // MongoDB connection string
    crypto: {
...
//-------------------------------------------DB connection---------------------------------------------------
// DB connection uses MONGO_URL defined above
